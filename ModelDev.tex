...
\begin{figure}[htbp]
    ...
    \end{minipage}
    \begin{minipage}[b]{.3\linewidth}
        \resizebox{\linewidth}{!}{\subinputfrom{\diagrampath}{PotatoMeshed2.eps_tex}}
    \end{minipage}
    \begin{minipage}[b]{.3\linewidth}
...
%\todo{If you have time and the inclination, I would expand this section significantly.  The code work was a considerable part of your research and only dedicating a few paragraphs does not do it justice.}
