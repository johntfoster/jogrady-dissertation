...
%\begin{align}
%w &= \frac{c\;s^2}{2}\notag \\
%W &= \frac{c}{2}\int_\mathcal{H} \omega(|\boldsymbol{\xi}|)\left( \frac{\epsilon_{ij}^d\xi_i\xi_j}{|\boldsymbol{\xi}|} \right)\left( \frac{\epsilon_{kl}^d\xi_k\xi_l}{|\boldsymbol{\xi}|} \right)\;dV_\boldsymbol{\xi}\notag\\
%&= \frac{c}{2}\epsilon_{ij}^d \epsilon_{kl}^d \int_\mathcal{H} \frac{\omega(|\boldsymbol{\xi}|)}{|\boldsymbol{\xi}|^2}\xi_i\xi_j\xi_k\xi_l \notag
%\end{align}
\begin{align}
w &= \frac{c\;s^2}{2}\notag \\
