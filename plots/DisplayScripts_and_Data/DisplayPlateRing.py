...
namelist = ["./PlateRing3_n300_h31_g1_2_1_exp_4.npz",
    "./PlateRing3_n200_h31_g1_2_1_exp_4.npz",
    "./PlateRing3_n80_h31_g1_1_exp_16.npz"]
labellist = ["300 nodes/length, horizon .010","200 nodes/length, horizon .015"," 80 nodes/length, horizon .038"]
...
ax2.plot(pdX01c,pdX1c,ls="None", marker="v",markevery=(0,30),label=labellist[datanumber])
...
ax2.plot(pdX01c,pdX1c,ls="None", marker="o",markevery=(6,20),label=labellist[datanumber])
...
ax2.plot(pdX01c,pdX1c,ls="None", marker="o",markevery=(8,10),label=labellist[datanumber])

ax2.set_xlim([0,1.0])
ax2.set_xticks(np.linspace(0.0,1.0,num=5))
ax2.set_ylim([0.0,0.01])
ax2.set_yticks(np.linspace(0.0,0.01,num=5))
ax2.yaxis.tick_right()
    
ax1.legend(loc='lower center',bbox_to_anchor=(0.5,-1.4))

# plt.suptitle('Proving Ring in Tension', fontsize=16)
plt.show()

if saving:
    fig.savefig("../PlateRing_n.pgf")
plt.show()
