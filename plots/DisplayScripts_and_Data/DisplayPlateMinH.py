...
#Load PD plate data
PDfile1name = "./Nu33_n201_h01_g0pt1/Nu33_n201_h01_g0pt1_1_exp_8.npz"
...
#Load PD plate data
pdHorizon2 = 0.05
PDfile2name = "./Nu33_n201_h015_g0pt1/Nu33_n201_h015_g0pt1_1_exp_1.npz"
...
#Load PD plate data
pdHorizon3 = 0.05
PDfile3name = "./Nu33_n201_h02_g0pt1/Nu33_n201_h02_g0pt1_1_exp_3.npz"
...
ax2=ax.plot(pdX1c,pdZ1c,ls="None", marker="^",markevery=(0,6),label="200 nodes, h=0.010")
ax3=ax.plot(pdX2c,pdZ2c,ls="None", marker="s",markevery=(2,6),label="200 nodes, h=0.015")
...
if saving:
    ...
    fig.savefig("./writeup/plots/elasticPlate_minimum_h.pgf")
plt.show()
