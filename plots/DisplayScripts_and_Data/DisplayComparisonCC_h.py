...
#Load PD plate data
PDfile1name = "./Clamped_n1000_h020_g001_ext04/Clamped_n1000_h020_g001_ext04_1_exp_16.npz"
...
ax2=ax.plot(pdX01c,pdZ1c,ls="None", marker="^",markevery=(0,20),label="1000 nodes, h=0.02")
...
if saving:
    ...
    fig.savefig("./writeup/plots/clamped_convergence_h.pgf")
plt.show()
