...
namelist = ["./BeamRing_newInt_n160_h05_g1/BeamRing_newInt_n160_h05_g1_1_exp_88.npz",
    "./BeamRing_newInt_n320_h05_g1/BeamRing_newInt_n320_h05_g1_1_exp_63.npz",
    "./BeamRing_newInt_n320_h10_g1/BeamRing_newInt_n320_h10_g1_1_exp_35.npz"][1::]
labellist = [" 504 nodes, horizon .032","1006 nodes, horizon .016","1006 nodes, horizon .032"][1::]
...
if saving:
    ...
    fig.savefig("./writeup/plots/beamRing_h.pgf")
plt.show()
