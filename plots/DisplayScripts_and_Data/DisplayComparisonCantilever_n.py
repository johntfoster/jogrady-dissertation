...
#Load PD plate data
PDfile1name = "./Cantilever_n500_h10_ext10_g001/Cantilever_n500_h10_ext10_g001_1_exp_25.npz"
...
#Load PD plate data
pdHorizon2 = 0.05
PDfile2name = "./Cantilever_n250_h05_ext10_g001_cont/Cantilever_n250_h05_ext10_g001_cont_1_exp_27.npz"
...
ax2=ax.plot(pdX01c,pdZ1c,ls="None", marker="^",markevery=(0,20),label="500 nodes, h=0.05")
ax3=ax.plot(pdX02c,pdZ2c,ls="None", marker="s",markevery=(5,10),label="250 nodes, h=0.05")
...
if saving:
    ...
    fig.savefig("./writeup/plots/clamped_cantilever_n.pgf")
plt.show()
