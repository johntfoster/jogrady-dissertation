...
namelist = ["./BeamRing_newInt_n160_h05_g1_1_exp_88.npz",
    ...
    "./BeamRing_newInt_n320_h10_g1_1_exp_35.npz"][::2]
labellist = [r" 160 nodes/length, $\delta=0.032$",r" 320 nodes/length, $\delta=0.016$",r" 320 nodes/length, $\delta=0.032$"][::2]
